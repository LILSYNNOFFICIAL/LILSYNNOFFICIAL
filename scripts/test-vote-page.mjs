...
assert.match(html,/site-shell\.js/i,'vote page must load the canonical site shell');
assert.match(shell,/LS_BG_STARS\.webm/,'canonical shell must provide the stars WebM background');
