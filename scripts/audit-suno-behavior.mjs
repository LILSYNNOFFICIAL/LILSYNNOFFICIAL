...
const contracts=[
  ...
  {name:'lyrics builder',fn:'lyricsBuilder',fields:['lyrics-title','section-list'],output:'TAG REFERENCE',guard:'Add at least one song section'},
...
console.log(`Suno behavioral audit PASS — ${contracts.length} tool handlers expose their required inputs, guards, and output contracts; shared interactions are wired.`);
