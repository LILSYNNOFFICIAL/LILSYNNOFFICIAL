...
const regular=new Set(['/archive.html','/releases.html','/gallery.html','/universe.html','/release.html','/special_access.html','/privacy.html','/terms.html','/coming_soon.html','/videos.html','/lore.html','/lore','/404.html','/site-health.html','/index3.html','/syntient_records/index.html','/syntient_records/ZiggyAndChickenman/index.html','/SynovaMedia/index.html']);
...
function init(){injectCss();bg();particles();geometry();orbGalaxy();if(vote.has(path)){document.querySelectorAll('.topbar,.nav-stack,.menu-panel,.footer').forEach(x=>x.remove());document.body.classList.add('ls-vote-canonical-page')}else{menu();footer()}normalize();document.body.classList.add('ls-canonical-page')}
