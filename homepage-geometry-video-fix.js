(()=>{
  ...
  const geometryVisibility=()=>{
    ...
    s.textContent=`
      ...
      .ls-vote4{margin-top:9px!important;border-color:rgba(255,0,143,.82)!important;background:rgba(255,0,143,.08)!important;color:#fff!important;box-shadow:0 0 18px rgba(255,0,143,.12)!important}
