...
const run=async()=>{
 ...
 if(videoGrid){
   const videoMap={'Rescue You (Acoustic Version)':'Glh5acZNiFM','Somewhere In-Between':'q_EENWIxiUA','Black Glass':'vebiWy-RL4Y','Static On My Tongue':'JRJswRmhbmA',"It's In Her Eyes":'NMFONDfJoi8','Fade Into You':'tfVl30iEMkg','Heal':'_1w0aG-lj8U','Hindsight':'HX5EZCPsAxI','Back From The Blackout':'WejkZ945Jt8'};
 ...
 if(hero){
   ...
   if(stack&&row){
     ...
     const mobile=document.createElement('style');mobile.textContent='@media(max-width:600px){.hero-cta-row{flex-wrap:wrap!important}.hero-cta-row a{padding-left:1rem!important;padding-right:1rem!important;font-size:.8rem!important}}';document.head.appendChild(mobile);
   }
 }
