(() => {
  ...
  const boot = () => {
    ...
    style.textContent = `
      ...
      body{margin:0!important;overflow-x:hidden!important;background:transparent!important;display:flex!important;flex-direction:column!important;min-height:100vh!important;}
      ...
      #secondary-page-header{position:relative!important;z-index:2!important;text-align:center!important;padding:118px 24px 38px!important;}
      #secondary-page-header img{display:block!important;width:min(72vw,260px)!important;height:auto!important;max-height:220px!important;object-fit:contain!important;margin:0 auto 18px!important;}
      #secondary-page-header h1{margin:0!important;font:700 clamp(2rem,5vw,3.5rem) Orbitron,sans-serif!important;letter-spacing:.18em!important;color:#fff!important;}
      #secondary-page-header p{margin:12px 0 0!important;font:400 clamp(1rem,2.2vw,1.25rem) Rajdhani,sans-serif!important;letter-spacing:.08em!important;color:rgba(255,255,255,.82)!important;}
      #site-footer{position:relative!important;z-index:2!important;margin-top:auto!important;padding:3rem 1.5rem 1.75rem!important;text-align:center!important;border-top:1px solid rgba(255,0,143,.20)!important;background:rgba(0,0,0,.48)!important;}
      #site-footer .footer-brand{font:700 1.25rem Orbitron,sans-serif;color:#ff008f;}
      #site-footer .footer-tagline{margin-top:.75rem;font:400 1rem Rajdhani,sans-serif;color:#999;}
      #site-footer nav{margin-top:1.25rem;display:flex;flex-wrap:wrap;justify-content:center;gap:.5rem 1.25rem;font:600 .875rem Rajdhani,sans-serif;}
      #site-footer a{color:#999;text-decoration:none;transition:color .2s ease;}
      #site-footer a:hover,#site-footer a:focus-visible{color:#ff4fd8;}
      #site-footer .footer-socials{display:flex;flex-wrap:wrap;justify-content:center;gap:.65rem 1rem;margin-top:1.5rem;}
      #site-footer .footer-socials a{font-size:.8rem;color:#ff1493;}
      #site-footer .footer-legal{margin-top:1.25rem;}
      #site-footer .footer-copy{margin-top:1.5rem;color:#666;font:400 .875rem Rajdhani,sans-serif;}
      ...
      body>main,body>section,body>.wrap,body>div:not(#sideMenu):not(#secondary-site-nav):not(#secondary-bg-overlay):not(#bgVideo):not(#site-footer):not(#secondary-page-header),body>footer{position:relative;z-index:2;}
      @media(max-width:640px){
        ...
        #secondary-page-header{padding:100px 18px 28px!important;}
        #secondary-page-header img{width:min(68vw,220px)!important;max-height:180px!important;}
    ...
    document.querySelectorAll('#siteBgVideo,#siteBgOverlay,#bgVideo,#secondary-bg-overlay,#secondary-site-nav,#sideMenu,#secondary-page-header,#site-footer').forEach(el => el.remove());
    ...
    const header=document.createElement('header'); header.id='secondary-page-header'; header.innerHTML=`<img src="/assets/img/LS.png" alt="LIL SYNN"><h1>LIL SYNN</h1><p>Dark sound. Raw emotion. No limits</p>`; const firstContent=[...document.body.children].find(el=>!['bgVideo','secondary-bg-overlay','secondary-site-nav','sideMenu'].includes(el.id)); if(firstContent)document.body.insertBefore(header,firstContent);else document.body.appendChild(header);

    const footer=document.createElement('footer'); footer.id='site-footer'; footer.innerHTML=`<div class="footer-brand">LIL SYNN</div><div class="footer-tagline">Music • Videos • Merch • Lyrics • Socials</div><nav aria-label="Footer navigation"><a href="/#music">Music</a><a href="/#videos">Videos</a><a href="https://lilsynnofficial.threadless.com/" target="_blank" rel="noopener noreferrer">Merch</a><a href="https://genius.com/artists/Lil-synn" target="_blank" rel="noopener noreferrer">Lyrics</a><a href="/#signal">SYNN SIGNAL</a><a href="/#contact">Contact</a></nav><div class="footer-socials" aria-label="Social profiles"><a href="https://www.youtube.com/@LILSYNNOFFICIAL" target="_blank" rel="noopener noreferrer">YouTube</a><a href="https://open.spotify.com/artist/6ozcOAnRAUPn3z5c0GR5kU" target="_blank" rel="noopener noreferrer">Spotify</a><a href="https://music.apple.com/us/artist/lil-synn/1850720041" target="_blank" rel="noopener noreferrer">Apple Music</a><a href="https://www.instagram.com/lilsynnofficial/" target="_blank" rel="noopener noreferrer">Instagram</a><a href="https://x.com/lilsynnofficial" target="_blank" rel="noopener noreferrer">X</a><a href="https://soundcloud.com/lilsynnofficial" target="_blank" rel="noopener noreferrer">SoundCloud</a><a href="https://www.tiktok.com/@lilsynnofficial" target="_blank" rel="noopener noreferrer">TikTok</a><a href="https://www.facebook.com/lilsynnofficial" target="_blank" rel="noopener noreferrer">Facebook</a></div><nav class="footer-legal" aria-label="Explore"><a href="/#music">Music</a><a href="/releases.html">Releases</a><a href="/#videos">Videos</a><a href="/#about">About</a><a href="https://genius.com/artists/Lil-synn" target="_blank" rel="noopener noreferrer">Lyrics</a></nav><nav class="footer-legal" aria-label="Connect"><a href="https://open.spotify.com/artist/6ozcOAnRAUPn3z5c0GR5kU" target="_blank" rel="noopener noreferrer">Spotify</a><a href="https://music.apple.com/us/artist/lil-synn/1850720041" target="_blank" rel="noopener noreferrer">Apple Music</a><a href="https://www.youtube.com/@LILSYNNOFFICIAL" target="_blank" rel="noopener noreferrer">YouTube</a><a href="https://www.instagram.com/lilsynnofficial/" target="_blank" rel="noopener noreferrer">Instagram</a><a href="https://www.tiktok.com/@lilsynnofficial" target="_blank" rel="noopener noreferrer">TikTok</a></nav><nav class="footer-legal" aria-label="Official"><a href="https://lilsynnofficial.threadless.com/" target="_blank" rel="noopener noreferrer">Merch</a><a href="/#signal">SYNN Signal</a><a href="/#contact">Contact</a><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a></nav><div class="footer-legal"><a href="/privacy.html">Privacy</a><a href="/terms.html">Terms</a></div><div class="footer-copy">© 2026 LIL SYNN</div>`; document.body.appendChild(footer);
